...
public class DragLayout extends FrameLayout {
    ...
    private final ViewDragHelper.Callback dragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            ...
            Log.d("DragLayout","clampViewPositionHorizontal:"+"left:" + left +":dx:"+dx);
            if (mainLeft + dx < 0) {
                return 0;
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            /*if(status == Status.CLOSE){//关闭时候不拦截事件
                return false;
            }*/
            Log.d("DragLayout","tryCaptureView:"+"pointerId:" + pointerId );
            return true;
        }
        /**
         * 设置水平方向滑动的最远距离
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            Log.d("DragLayout","onViewReleased:" + "xvel:"+ xvel + ":yvel:" + yvel);
        ...
        public void onViewPositionChanged(View changedView, int left, int top,
                int dx, int dy) {
            Log.d("DragLayout","onViewPositionChanged:" +  "left:"+ left + ":top:" + top + "dx:"+ dx + ":dy:" + dy);
    ...
    class YScrollDetector extends SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float dx, float dy) {
            Log.d("DragLayout","YScrollDetector: onScroll " +  "dx:"+ dx + ":dy:" + dy );
    ...
    protected void onFinishInflate() {
        ...
        Log.d("DragLayout","onFinishInflatel "  );
        ...
        //左侧界面
        vgLeft = (FrameLayout) getChildAt(0);
        //右侧(主)界面
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.d("DragLayout","onSizeChanged " + "w:" + w + ":h:" + h + ":oldw:" + oldw +": oldh :" + oldh + ":width:" + width +":height:" + height);
        // range = (int) context.getResources().getDimension(R.dimen.fragment_me_bellow_bg_width);
        //可以水平拖拽滑动的距离 一共为屏幕宽度的75%
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        Log.d("DragLayout","onLayout " + "changed:"+changed+ ":left:" + left + ":top:" + top + ":right:" + right +": bottom :" + bottom);
        vgLeft.layout(0, 0, width, height);
        vgMain.layout(mainLeft, 0, mainLeft + width, height);
    }
